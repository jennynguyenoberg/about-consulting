export default function USPs() { 
  return (
    <section className="grid grid-cols-3 gap-4 border-t-2 border-b-2 border-salmon-500">
      <div className="pl-10 py-20 border-2 border-apricot-500 border-r-salmon-500 h-full">
