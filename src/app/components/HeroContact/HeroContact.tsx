      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 py-20 px-10 lg:py-20 gap-16 bg-salmon-500 justify-center items-center">
        ...
        <div className="flex flex-col items-start lg:pr-36">
          ...
          <p className="text-xl mb-8">
            ...
            sortiment- och inköpschef på den snabbväxande startupen Kavall samt
            mångårig erfarenhet av inköp, Category Management, produktutveckling
            och teamledning på bolag som Lidl och ICA.
          </p>
          <p className="text-xl mb-8">
            Marika är också "about" sin familj och cocker spanieln Madde, att
            sjunga och upptäcka världens alla hörn!
          </p>
