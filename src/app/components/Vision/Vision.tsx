  ...
  return (
    <section>
      <div className="grid grid-cols-1 lg:grid-cols-2 text-aubergine-500 justify-center items-center border-b-2 border-salmon-500">
        <div className="p-20 lg:py-36 lg:px-28 bg-salmon-500 text-center flex items-center flex-col">
          ...
          <p className="text-3xl lg:text-5xl mt-5">
            "Vi älskar<em className="text-4xl lg:text-5xl"> att driva affärer inom ett område som vi personligen brinner för och About är med dig från idé till lönsamhet.</em>"
          </p>
